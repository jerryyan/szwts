...
<div id="links_form_edit_panel">
	<div id="links_form_edit_layout">
		<div title="基本信息" style="padding:10px 20px;">
			<div class="fitem">
				<label>网站名称：</label>
				<input type="text" name="webname" value="<?php echo ($tempData['webname']); ?>" size="20" />
			</div>
			<div class="fitem">
				<label>类型：</label>
				<select name="type">
			...
			<div class="fitem">
				<label>官网链接：</label>
				<input type="text" name="weblink" value="<?php echo ($tempData['weblink']); ?>" size="40" />
			</div>
			<div class="fitem">
				<label>状态：</label>
...
var links_type = <?php echo (($tempData['type_id'])?($tempData['type_id']):1); ?>,
	links_status = <?php echo (($tempData['status'])?($tempData['status']):0); ?>;
