...
<div class="l_center cr">
	<div class="l_center_01">
        <div class="cuowu" style="text-align:center;margin-top:200px; float:left; width:960px;">
        <?php if(isset($message)): ?><span class="cw2" title="成功"><?php echo ($message); ?></span>
        <?php else: ?>
        <span class="cw3" title="错误"><?php echo ($error); ?></span><?php endif; ?>
        <div class="fanhui"><a href="<?php echo ($jumpUrl); ?>"><span>跳转</span></a></div>
        </div>
    </div>
</div>
<!-- 右侧内容   end -->
