...
<div id="content">
	<div class="leftsidebar">
        ...
        <ul>
        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="__URL__/index/id/<?php echo ($v["id"]); ?>.html" class="<?php if(($v[id] == $modules_result[id])): ?>mover<?php endif; ?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
	</div>
	<div class="rightcontent">
    	<div class="about_title"><?php echo (($modules_result['name'])?($modules_result['name']):''); ?></div>
    	
    	<?php if(($modules_result[is_list] == 0)): ?><div class="about_content">
	        	<?php echo (($content)?($content):''); ?>
	        </div>       
        <?php else: ?>        
	        <div class="news_content">
	        	<ul>
	        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="__URL__/details/id/<?php echo ($v["id"]); ?>.html"><?php echo ($v["title"]); ?></a> <span><?php echo (date('Y-m-d', $v["addtime"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
	            </ul>
	        </div>
	        <div class="last_list2">
	       		<?php echo ($page); ?>
			</div><?php endif; ?>
