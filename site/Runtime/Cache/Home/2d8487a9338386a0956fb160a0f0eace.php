...
<div class="cenner">
	...
	<div class="list_neir">
		<div class="list_left">
	    	<div class="li_bt">
	    		<h1 class="tiet"><?php echo ($articles_result['title']); ?></h1>
	    		<p>发布时间：<?php echo (date('Y-m-d H:i:s', $articles_result['addtime'])); ?></p>
	    	</div>
	    	<div class="li_zyao"><span>摘要：</span><?php echo ($articles_result['summary']); ?></span></div>
	    	<div class="li_neir"><?php echo ($articles_result['content']); ?></div>
    	</div> 
    </div>
...
<div class="foot" style="width:100%; font-size:14px;">
	...
	<span>Copyright © 2014 www.wangtousuo.com . All Rights Reserved. 版权所有：深圳市伟泰投资发展有限公司 - <a href="http://www.beianbeian.com/search/wangtousuo.com" target="_blank" style="color:#ccc;">粤ICP备14094677号-1</a><script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1254152294'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s95.cnzz.com/z_stat.php%3Fid%3D1254152294%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));</script>  </span>
</div>
