...
<div id="content">
	...
	<div class="content_right">
		...
		<div class="zdtb_title">投资分析</div>      
		<div class="scxx_bg" style="margin-left:10px;">
			<table border="0">
				<tr class="tr_01">
					<td class="t_3" height="40" align="center" valign="middle" bgcolor="#ececec">序号</td>
                    <td class="t_3"height="40" align="center" valign="middle" bgcolor="#ececec">所在平台</td>
                    <td class="t_3"height="40" align="center" valign="middle" bgcolor="#ececec">投资总额</td>
                    <td class="t_3"height="40" align="center" valign="middle" bgcolor="#ececec">投资比例</td>
                    <td class="t_3"height="40" align="center" valign="middle" bgcolor="#ececec">综合收益</td>
				</tr>
				<?php if(($count > 0)): if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="tr_01">
                    <td class="t_2" align="center" valign="middle"><?php echo ($k); ?></td>
                    <td class="t_2" align="center" valign="middle"><?php echo ($v['platform_name']); ?></td>
                    <td class="t_2" align="center" valign="middle"><?php echo ($v['sum_amount']); ?></td>
                    <td class="t_2" align="center" valign="middle"><?php echo ($v['scale']); ?>%</td>
                    <td class="t_2" align="center" valign="middle"><?php echo ($v['sum_rate']); ?></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?> 
				<?php else: ?>
				<tr class="tr_01"><td class="t_2" colspan="5">暂无数据</td></tr><?php endif; ?>        
			</table>
		</div>	
