...
<div id="content">
    ...
    <ul class="submenu">
        ...
        <li><a href="/Center/Reward.html" class="<?php if(($center_menu_num == 6)): ?>su_b2<?php endif; ?>">奖励提现</a></li>
        <li><a href="/Center/Viewhistory.html" class="<?php if(($center_menu_num == 7)): ?>su_b2<?php endif; ?>">投资分析</a></li>
    </ul>
</div>
	<!-- 左侧菜单   end -->
        ...
        <div class="scxx_bg" style="margin-left:10px;">
            <table border="0">
                ...
                <tr class="tr_01">
                    ...
                    <td class="t_2" align="center" valign="middle">100000 </td>
                    <td class="t_2" align="center" valign="middle">2.1</td>
                    <td class="t_2" align="center" valign="middle">22 </td>
</tr>
                <tr class="tr_01">
                    <td class="t_2" align="center" valign="middle">  1 </td>
                    <td class="t_2" align="center" valign="middle">	国诚金融 </td>
