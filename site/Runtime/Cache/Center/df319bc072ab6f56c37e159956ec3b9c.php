        ...
        <div class="rznr" style=" border:0px;">
		  	<div class="form_nr">
                <div class="input_nr" style="margin-bottom:15px;">
                	...
                	<span><?php echo ($tempData['user_result']['realname']); ?></span>
                </div>
                <div class="input_nr" style="margin-bottom:15px;">
                	...
                	<span>
                		<?php if(($tempData[user_result][sex] == 1)): ?>男
                		<?php else: ?>
                			女<?php endif; ?>
					</span>
                </div>
                ...
                <div class="input_nr">
               	...
               	<div class="shanchuang" style=" padding-bottom:0px;">
                	<div class="z2"><img src="/static/<?php echo ($tempData['user_result']['card_pic1']); ?>" height="157" /></div>
                </div>
                ...
                <div class="input_nr">
               	...
               	<div class="shanchuang" style=" padding-bottom:0px;">
                	<div class="z2"><img src="/static/<?php echo ($tempData['user_result']['card_pic2']); ?>" height="157" /></div>
                </div>
