        ...
        <div class="rznr">
			<form id="reBindByEmailForms" action="__GROUP__/Email/verifyoldbyemail" method="post" class="form_nr">
		        <div class="input_nr" style="margin-bottom:20px;">
		        	<input id="email" name="email" type="hidden" value="<?php echo ($tempData['user_result']['email']); ?>" />
		        	<span style="width:90px; text-align:right;">已验证邮箱</span><span><?php echo ($tempData['user_result']['email_hide']); ?></span>
		        </div>
		      	<div class="input_nr">
