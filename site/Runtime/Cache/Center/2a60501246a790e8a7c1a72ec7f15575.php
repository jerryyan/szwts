...
<div id="content">
	...
	<div class="content_right">
        ...
        <div class="rznr">
		  	...
		  	<form id="newEmailForms" action="__GROUP__/Email/verifynewbyemail" method="post" class="form_nr">
			  <div class="input_nr">
			  	...
			  	<input id="keycode" name="keycode" type="hidden" value="<?php echo ($tempData['keycode']); ?>" />
